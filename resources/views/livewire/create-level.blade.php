<div>
        ...
        <div wire:click="$set('showAddLevelModal', false)" class="overlay">
            <div wire:click.stop class="popup">
                ...
                <form wire:submit.prevent="save" class="space-y-4">
                    ...
                    <textarea wire:model="description" placeholder="Description" class="input-text"></textarea>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="relative flex-1">
                                <input type="number" wire:model.live="availability_time_days" min="0" max="364"
                                    placeholder="0"
                            ...
                            <div class="relative flex-1">
                                <input type="number" wire:model.live="availability_time_hours" min="0" max="23"
                                    placeholder="0"
                            ...
                            <div class="relative flex-1">
                                <input type="number" wire:model.live="availability_time_minutes" min="0" max="59"
                                    placeholder="0"
                    ...
                    <div class="btn-group">
                        ...
                        <button type="button" wire:click="$set('showAddLevelModal', false)" class="cancel-btn">
                            Cancel
                        </button>
                    </div>
                </form>
    ...
    @if($showMapModal)
        <div wire:click="cancelMapSelection" class="map_overlay">
        ...
        function mapComponent2() {
            return {
                ...
                initMap() {
                    this.$nextTick(() => {
                        setTimeout(() => {
                            const init_latitude = this.$wire.latitude ?? this.$wire.base_latitude;
                            const init_longitude = this.$wire.longitude ?? this.$wire.base_longitude;

                            if (this.$refs.mapContainer && !this.map) {
                                this.map = L.map(this.$refs.mapContainer).setView([init_latitude, init_longitude], 13);
